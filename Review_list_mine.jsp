...
<script src="https://kit.fontawesome.com/ae9cc237fc.js"
	crossorigin="anonymous"></script>
<link rel="stylesheet" type="text/css" href="./css/cardtest_mine.css">
				...
				<div class="carousel-item active">
					<div class="card" id="card1">
						<div class="border">
							...
							<div class="propil">
								<img
									src="https://pbs.twimg.com/media/FsWYFhbaQAAd2ax?format=jpg&name=large"
									alt="poster" />
							</div>
							<hr />
							<div id="footer">
								<span id="date" class="footer-sub"> 2023-04-21 </span> <span
									...
									class="fa-sharp fa-solid fa-heart" id="orange-like"
									style="color: #F58700"></i> 10
							...
							<div id="update-delete">
								<span id="update"><a href="#"> 수정</a></span> <span id="delete"><a
									href="#"> 삭제</a></span>
							</div>
						</div>
					</div>
